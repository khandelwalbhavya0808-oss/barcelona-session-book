      ...
      <div className="relative w-full max-w-md space-y-8 rounded-sm border border-border bg-surface p-8 shadow-xl text-center overflow-hidden">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="mt-3 text-sm text-muted-foreground leading-relaxed max-w-xs">
            You do not have the administrative privileges required to access this section of the
            system.
          </p>
        </div>
        ...
        <div className="mt-8 space-y-3">
          <Button
            asChild
            className="w-full bg-accent hover:bg-accent/90 text-accent-foreground rounded-sm font-semibold tracking-wide uppercase text-xs h-10"
          >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Button
              asChild
              variant="ghost"
              className="w-full rounded-sm text-xs uppercase tracking-wider text-muted-foreground hover:text-accent h-10"
            >
              <Link to="/logout">
